...
%macro import_single(num);
	...
	infile "../raw_file/revised/REVISEDPUMS5_&num..TXT" DLM='090D'x pad truncover lrecl=266;
	input
		RECTYPE: $1-1
		SERIALNO: $2-8
		SAMPLE: $9-9
	...
	infile "../raw_file/revised/REVISEDPUMS5_&num..TXT" DLM='090D'x pad truncover lrecl=316;
	input
		RECTYPE: $1-1
		SERIALNO: $2-8
		PNUM: $9-10
